...
class AppDynamicsJob(unittest.TestCase):
    ...
    def test_app_dynamics_job(self):
        ...
        driver.find_element(By.XPATH,"//div[@id='app']/div/div/div/form/div[2]/div/div[2]/div/input").click()
        ...
        driver.find_element(By.XPATH,"//div[@id='app']/div/div/div/form/div[2]/div/div[3]/div/input").click()
        ...
        for i in range(60):
            try:
                if self.is_element_present(By.XPATH, "//div[contains(text(),'Formulario enviado correctamente')]"): break
            except: pass
            time.sleep(1)
